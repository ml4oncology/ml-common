...
DEFAULT_IMPUTE_COLS = {
    ...
    'most_frequent': SYMP_COLS + SYMP_CHANGE_COLS + ['patient_ecog', 'patient_ecog_change'],
    'median': []
}
# one-hot encoding
DEFAULT_ENCODE_COLS = ['regimen', 'intent']
# outlier clipping
DEFAULT_CLIP_COLS = ['body_surface_area', 'height', 'weight'] + LAB_COLS + LAB_CHANGE_COLS
# normalization
DEFAULT_NORM_COLS = [
    'age', 
    'body_surface_area', 
    ...
    'visit_month_cos', 
    'weight', 
] + DRUG_COLS + LAB_COLS + LAB_CHANGE_COLS + SYMP_COLS + SYMP_CHANGE_COLS
